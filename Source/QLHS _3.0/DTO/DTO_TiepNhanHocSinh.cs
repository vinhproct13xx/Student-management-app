...
namespace DTO
{
    public class DTO_TiepNhanHocSinh
    {
        ...
        public DTO_TiepNhanHocSinh(int mahs, string hoten, string diachi, string ngaysinh, string gioitinh, string tongiao, string dantoc, string hotencha, string nghenghiepcha, string hotenme, string nghenghiepme)
        {
            this.MAHS = mahs;
            this.HOTEN = hoten;
            this.DIACHI = diachi;
