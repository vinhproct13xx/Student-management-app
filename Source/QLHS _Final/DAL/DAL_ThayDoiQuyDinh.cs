...
namespace DAL
{
    public class DAL_ThayDoiQuyDinh : DBConnect
    {
...

        {
            ...
            string sqlInsert = "insert into QUYDINH values ( " + dtoQuyDinh._TuoiMax + ", " + dtoQuyDinh._TuoiMin + " , " + dtoQuyDinh._SiSo + ", " + dtoQuyDinh._DiemDat + ", " + dtoQuyDinh._DiemMax + "," + dtoQuyDinh._DiemMin + "," + dtoQuyDinh._Lop10 + "," + dtoQuyDinh._Lop11 + "," + dtoQuyDinh._Lop12 + ")";
            _conn.Open();
